...
export default async function Song({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main className="archive-page song-page">
    ...
    <div className="lyrics-layout"><section id="lyrics"><p className="section-number">02 / Lyrics</p><h2>{item.title}</h2><div className="song-lyrics">{songLyrics.split(/\n\s*\n/).map((stanza, i) => <p key={i}>{stanza.replace(/\*\*/g, '')}</p>)}</div></section><aside className="song-notes"><h2>About the recording</h2><p>{item.note}</p><p>Created through human–AI collaboration, with AI-generated music and vocals from Suno and AI-generated artwork.</p><p>The lyrics shown here are the supplied song text. Vocal phrasing and repeated lines in the recording may vary.</p><a href="/archive#music">Explore Before the Dawn</a><a href="/contact">Share feedback or a correction</a><a href="https://buymeacoffee.com/capto50z" target="_blank" rel="noreferrer">Optional support</a></aside></div>
