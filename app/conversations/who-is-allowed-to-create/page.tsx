...
export default function WhoIsAllowedToCreate() {
  return <main className="archive-page">
    ...
    <div className="archive-content">
      ...
      <DiscussionInvitation reddit={redditDiscussions['who-is-allowed-to-create']} title={title} rumble="https://rumble.com/v7fxizo-who-is-allowed-to-create-who-gets-left-behind.html" tiktok="7689135396587900191" />
